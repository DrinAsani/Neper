...
- Hood decor rendering now explicitly supports distinct placeholder visuals for apartment blocks, courtyard tile grid, trees, concrete blocks, parking lanes, school path, and graffiti/hangout corner so the hood reads clearly during gameplay even without final art assets.
